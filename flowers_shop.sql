...
-- Records of fl_buy
-- ----------------------------
INSERT INTO `fl_buy` VALUES ('36', 'CG2022005272877', '2022-05-27', '祖一一', '祖一一', '6', '唐山农产品', '6', '盆', '16', '已通过', '哈哈', '2022-05-27', '');
INSERT INTO `fl_buy` VALUES ('37', 'CG202200527893', '2022-05-27', '张三三', '张三三', '8', '天天农产品', '34', '箱/瓶', '12', '未审核', null, null, null);
INSERT INTO `fl_buy` VALUES ('38', 'CG2022005278850', '2022-05-25', '张三三', '张三三', '14', '天天农产品', '2', '盆', '300', '未审核', null, null, null);
INSERT INTO `fl_buy` VALUES ('39', 'CG2022005272397', '2022-05-27', '祖一一', '祖一一', '11', '北京农产品', '2', '盆', '80', '未审核', null, null, null);
INSERT INTO `fl_buy` VALUES ('40', 'CG202200528827', '2022-05-28', '祖一一', '祖一一', '15', '北京农产品', '8', '件/24盆', '130', '已通过', '哈哈', '2022-05-28', '');
INSERT INTO `fl_buy` VALUES ('41', 'CG2022005284012', '2022-05-28', '祖一一', '祖一一', '36', '天天农产品', '6', '盆', '23', '已通过', '哈哈', '2022-05-28', '');
...
-- Records of fl_out
-- ----------------------------
INSERT INTO `fl_out` VALUES ('19', '2022005114444', '王贝贝', '2022-05-11', '31', '3', '北京农产品', '2', '盆', '25', '50', '10', '50', '已出库');
INSERT INTO `fl_out` VALUES ('20', '2022005117941', '王贝贝', '2022-05-26', '7', '3', '天天农产品', '16', '盆', '45', '720', '352', '91', '已出库');
INSERT INTO `fl_out` VALUES ('21', '2022005126918', '王贝贝', '2022-05-12', '6', '3', '北京农产品', '4', '盆', '17', '68', '20', '17', '已出库');
INSERT INTO `fl_out` VALUES ('22', '202200527308', '王贝贝', '2022-05-27', '10', '3', '北京农产品', '5', '盆', '200', '1000', '400', '1000', '已出库');
INSERT INTO `fl_out` VALUES ('23', '2022005275825', '王贝贝', '2022-05-26', '14', '1', '天天农产品', '7', '盆', '300', '2100', '700', '2100', '已出库');
INSERT INTO `fl_out` VALUES ('24', '2022005273104', '王贝贝', '2022-05-19', '9', '3', '唐山农产品', '7', '盆', '56', '392', '147', '392', '已出库');
INSERT INTO `fl_out` VALUES ('25', '2022005276575', '王贝贝', '2022-05-20', '10', '3', '北京农产品', '3', '盆', '200', '600', '240', '600', '已出库');
INSERT INTO `fl_out` VALUES ('26', '2022005271397', '王贝贝', '2022-05-26', '10', '3', '北京农产品', '4', '盆', '200', '800', '320', '800', '已出库');
INSERT INTO `fl_out` VALUES ('27', '2022005271375', '王贝贝', '2022-05-27', '9', '12', '唐山农产品', '4', '盆', '56', '224', '84', '224', '已出库');
INSERT INTO `fl_out` VALUES ('28', '2022005276557', '王贝贝', '2022-05-20', '9', '3', '唐山农产品', '4', '盆', '56', '224', '84', '224', '已出库');
INSERT INTO `fl_out` VALUES ('29', '2022005289308', '王贝贝', '2022-05-28', '36', '1', '天天农产品', '6', '盆', '45', '270', '132', '270', '已出库');
...
CREATE TABLE `fl_product` (
  ...
  `name` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '农产品名称',
...
-- ----------------------------
INSERT INTO `fl_product` VALUES ('6', '蝴蝶兰', '4', '12', '16', '1', '唐山农产品', '24');
INSERT INTO `fl_product` VALUES ('7', '杜鹃花', '4', '23', '45', '2', '天天农产品', '27');
INSERT INTO `fl_product` VALUES ('8', '水仙花', '4', '12', '15', '20', '天天农产品', '11');
INSERT INTO `fl_product` VALUES ('9', '仙人指', '2', '35', '56', '19', '唐山农产品', '38');
INSERT INTO `fl_product` VALUES ('10', '倒挂金钟', '4', '120', '200', '99', '北京农产品', '23');
INSERT INTO `fl_product` VALUES ('11', '小丽花', '4', '80', '100', '10', '北京农产品', '11');
INSERT INTO `fl_product` VALUES ('12', '元宝树', '13', '100', '150', '100', '唐山农产品', '10');
INSERT INTO `fl_product` VALUES ('13', '巴西木', '13', '20', '80', '20', '桃山小娟', '11');
INSERT INTO `fl_product` VALUES ('14', '非洲茉莉', '13', '200', '300', '83', '天天农产品', '87');
INSERT INTO `fl_product` VALUES ('15', '金钻', '13', '130', '200', '10', '北京农产品', '11');
INSERT INTO `fl_product` VALUES ('16', '玉露', '2', '20', '60', '23', '天天农产品', '11');
INSERT INTO `fl_product` VALUES ('17', '法师', '2', '20', '50', '12', '北京农产品', '1');
INSERT INTO `fl_product` VALUES ('31', '金银花', '13', '20', '30', '18', '北京农产品', '2');
INSERT INTO `fl_product` VALUES ('32', '蝴蝶兰1', '4', '12', '16', '1', '唐山农产品', '24');
INSERT INTO `fl_product` VALUES ('33', '杜鹃花1', '4', '23', '45', '2', '天天农产品', '27');
INSERT INTO `fl_product` VALUES ('34', '金银花', '2', '20', '30', '0', '天天农产品', '0');
INSERT INTO `fl_product` VALUES ('35', '蝴蝶兰3', '4', '12', '16', '1', '唐山农产品', '24');
INSERT INTO `fl_product` VALUES ('36', '杜鹃花3', '4', '23', '45', '2', '天天农产品', '33');
...
-- Records of fl_put
-- ----------------------------
INSERT INTO `fl_put` VALUES ('23', 'RK202200527926', '17', '2022-05-26', '北京农产品', '张三三', '11', '盆', '20', '220', '已入库');
INSERT INTO `fl_put` VALUES ('24', 'RK2022005281159', '15', '2022-05-28', '北京农产品', '祖一一', '8', '件/24盆', '130', '96', '已入库');
INSERT INTO `fl_put` VALUES ('25', 'RK2022005284501', '36', '2022-05-28', '天天农产品', '祖一一', '6', '盆', '23', '138', '已入库');
...
INSERT INTO `fl_sale` VALUES ('11', 'CK20220050028900', '王贝贝', '2022-05-02', '31', '北京农产品', '18', '盆', '30', '540', '540', '哈哈', '已通过', '', '2022-05-27', null);
INSERT INTO `fl_sale` VALUES ('13', 'CK2022005263676', '王贝贝', '2022-05-26', '7', '天天农产品', '16', '盆', '23', '368', '20', '哈哈', '未审核', '', '2022-05-26', null);
INSERT INTO `fl_sale` VALUES ('17', 'CK2022005288773', '王贝贝', '2022-05-28', '15', '北京农产品', '6', '盆', '200', '1200', '200', null, '未审核', null, null, null);
...
CREATE TABLE `fl_sort` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '编号',
  `sortname` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '农产品类别名',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb3;
