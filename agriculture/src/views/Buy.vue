  ...
  <div style="width: 100%; height: 100%">
    ...
    >
      ...
      >
        ...
        <div>
          <div style="margin-top: 250px;height: 20px" class="headerr">
            <div style="width: 250px; height: 40px; float: left">
              <h3 style=" font-size: 15px">采购商品</h3>
            </div>
            <div style="width: 250px; height: 40px; float: left">
              <h3 style=" font-size: 15px">供应商</h3>
            </div>
            <div style="width: 250px; height: 40px; float: left">
              <h3 style=" font-size: 15px">采购数</h3>
            </div>
            <div style="width: 250px; height: 40px; float: left">
              <h3 style=" font-size: 15px">单位</h3>
            </div>
            <div style="width: 250px; height: 40px; float: left">
              <h3 style=" font-size: 15px">单价</h3>
            </div>
          </div>
          <div style="width: 100%; height: 50px; border-bottom: 1px solid #eee">
            <el-form-item style="width: 250px; float: left" prop="buyName">
              <el-select
            ...
            <el-form-item style="width: 250px; float: left" prop="buySupplier">
              <el-select
                style="
                  width: 200px;
                  margin-top: 10px;
            ...
            <el-form-item
              style="width: 180px; margin-top: 5px; float: left"
              prop="buyUnit"
            >
              <span style="margin-left: 20px">{{ form1.buyUnit }}</span>
            </el-form-item>

            <el-form-item style="width: 250px; float: left" prop="buyPrice">
              <el-input-number
                style="
                  width: 180px;
                  margin-top: 10px;
      ...
      >
        ...
        <div>
          ...
          <div style="width: 100%; height: 50px; border-bottom: 1px solid #eee">
            ...
            <span
              autocomplete="off"
              style="width: 500px; margin-top: 10px; float: left"
