<template>
  <div style="width: 100%; height: 100%">
    ...
    >
      ...
      <div>
        <el-button icon="Plus" @click="handleAddbuy" style="margin-left: 10px"
          ><i class="el-icon-circle-plus-outline"></i>新增销售订单</el-button
        >
        <el-popconfirm
          class="ml-5"
    ...
    >
      ...
      <el-table-column prop="proname" label="销售商品"> </el-table-column>
    ...
    >
      <template slot="title">
        <div style="font-size: 25px; font-weight: bold">新增销售订单</div>
      </template>
      <el-form
        :model="form1"
        :inline="true"
      ...
      >
        ...
        <div class="personal-mybuluo-head">
          <div class="personal-mybuluo-wording">销售订单明细</div>
        ...
        <div>
          <div style="margin-top: 200px" class="headerr">
            <div style="width: 250px; height: 40px; float: left">
              <h3 style="padding-top: 10px; font-size: 15px">销售商品</h3>
            </div>
            <div style="width: 250px; height: 40px; float: left">
            ...
            <div style="width: 100px; height: 40px; float: left">
              <h3 style="padding-top: 10px; font-size: 15px">销售数量</h3>
            </div>
            <div style="width: 100px; height: 40px; float: left">
          ...
          <div style="width: 100%; height: 50px; border-bottom: 1px solid #eee">
            ...
            <el-form-item style="width: 100px; float: left" prop="buyCount">
              <el-input-number
                @change="maxalert"
                type="number"
                placeholder="销售数量"
            ...
            <el-form-item style="width: 100px; float: left" prop="saleUnit">
              <el-cascader
                v-model.number="form1.saleUnit"
                placeholder="选择数量单位"
                style="width: 80px; margin-top: 10px; float: left"
                ref="cascaderAddr"
                :options="menuData"
                :props="{
                  expandTrigger: 'click',
            ...
            <el-form-item style="width: 100px; float: left" prop="price">
              <el-input-number
                @change="calculate"
                type="number"
                v-model="form1.price"
            ...
            <el-form-item style="width: 100px; float: left" prop="saleTotal">
              <el-input
                placeholder="总价格"
    ...
    >
      <template slot="title">
        <div style="font-size: 25px; font-weight: bold">修改销售订单</div>
      </template>
      <el-form
          :model="form1"
          :inline="true"
    ...
    >
      <template slot="title">
        <div style="font-size: 25px; font-weight: bold">查看销售订单</div>
      </template>
      <el-form
        :model="form1"
        :inline="true"
    ...
    >
      <template slot="title">
        <div style="font-size: 25px; font-weight: bold">审核销售订单</div>
      </template>
      <el-form
        :model="form1"
        :inline="true"
